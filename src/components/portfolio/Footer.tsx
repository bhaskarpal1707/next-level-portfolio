    ...
    <footer className="relative mt-28 border-t border-white/5">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <div className="flex flex-col gap-10 md:flex-row md:items-end md:justify-between">
          <div>
            <p className="font-mono2 text-[11px] uppercase tracking-[0.35em] text-teal-300/80">
              Let's build something
            </p>
            <Link
              to="/contact"
              className="group mt-4 inline-flex items-baseline gap-2 font-display text-4xl font-semibold tracking-tight text-slate-100 transition-colors hover:text-teal-300 sm:text-5xl"
            >
              Start a project
          ...
          <div className="space-y-3 text-sm">
            ...
            <a
              ...
              className="flex items-center gap-3 text-slate-300 transition-colors hover:text-teal-300"
            >
              <Phone className="h-4 w-4 text-teal-300/70" />
              {profile.phone}
            </a>
            ...
            <div className="flex gap-3 pt-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="glass glass-hover grid h-10 w-10 place-items-center rounded-xl text-slate-300"
                aria-label="GitHub"
              >
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-3 border-t border-white/5 pt-6 font-mono2 text-[11px] tracking-[0.25em] text-slate-600 sm:flex-row">
